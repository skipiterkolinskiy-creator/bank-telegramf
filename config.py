...
class Config:
    ...
    def from_env(cls) -> "Config":
        token = (os.getenv("API_TOKEN") or os.getenv("BOT_TOKEN") or "").strip()
        staff_group_id = int(os.getenv("STAFF_GROUP_ID", "-1003993331647"))
        database_dir = Path(os.getenv("DATABASE_DIR") or os.getenv("DATA_DIR") or "database")
